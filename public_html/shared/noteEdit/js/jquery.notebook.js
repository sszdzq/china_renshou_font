...
(function($, d, w) {
    ...
    var isMac = w.navigator.platform == 'MacIntel',
        ...
        events = {
            commands: {
				...
				superscript: function(e){ //上标
					e.preventDefault();
                    var s = utils.selection.save();
					s = '<sup>'+s+'</sup>';
					if (!!window.ActiveXObject || "ActiveXObject" in window){//IE
                       d.selection.createRange().pasteHTML(s);
                    }else{
                        d.execCommand('insertHTML',false,s);
                    }
					bubble.update.call(this);
                    events.change.call(this);
				},
				subscript: function(e){ //下标 
					e.preventDefault();
                    var s = utils.selection.save();
					s = '<sub>'+s+'</sub>';
                    if (!!window.ActiveXObject || "ActiveXObject" in window){//IE
				...
				img: function(e){ //图片
                    ...
                    // window.returnPic=function(retval){
                    //     if(retval!=null&&retval!=""){
                    //         var center='<img src="'+retval+'"></img>';
                    //         d.execCommand('insertHTML',false,center);
                    //         bubble.update.call(this);
                    //         events.change.call(this);
                    //     }
                    // };
                    // window.open("shuru.html","","width=225,height=200,menubar=no,toolbar=no,location=no,scrollbars=no,status=no,modal=yes");

					//var center = '<img src="data:image/png;base64,"></img>';
					var ret=window.prompt("请输入图片数据","");
                    if(ret!=null&&ret!=""){
                        d.execCommand('insertImage',false,ret);
                       bubble.update.call(this);
                       events.change.call(this);
                    }
    ...
    $.fn.notebook.defaults = {
        ...
        mode: 'multiline',
        modifiers: ['bold', 'italic', 'underline', 'h1', 'h2', 'ol', 'ul', 'anchor','img','superscript','subscript']
    };
